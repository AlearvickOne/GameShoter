...
public class Menu : AwakeMonoBehaviour
{
    [Header("MainMenu")]
    ...
    private void SavesGraphicsParameters()
    {
        PlayerPrefs.SetInt("dropdowmDefaultScreenValue", GraphicsSettings._dropdownScreenResolutionValue);
        PlayerPrefs.SetInt("dropdowmFullScreenValue", GraphicsSettings._dropdownFullScreenValue);
    }
    ...
    private void LoadGraphicsParameters()
    {
        GraphicsSettings._dropdownScreenResolutionValue = PlayerPrefs.GetInt("dropdowmDefaultScreenValue");
        GraphicsSettings._dropdownFullScreenValue = PlayerPrefs.GetInt("dropdowmFullScreenValue");
    }
    #endregion
}
